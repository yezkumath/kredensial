...
import DetailCredential_Certificate from "@/components/pages/credentials/applications/detail";
...
export default function Page() {
  ...
  if (isLoading) {
    ...
    return (
      <DetailCredential_Certificate appDetail={data} mutateAppDetail={mutate} />
    );
  }
}
